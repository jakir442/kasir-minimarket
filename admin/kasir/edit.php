            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        <!-- Header -->
                        <div class="mb-4">
                            <h3 class="fw-bold mb-1">✏️ Edit Kasir</h3>
                            <p class="text-muted mb-0">
                                Ubah data akun kasir
                            </p>
                        </div>

                        <!-- Form -->
                        <form action="../../proses/admin/edit/proses_edit_kasir.php" method="POST">
                            <input type="hidden" name="id_pengguna" value="<?= $kasir['id_pengguna']; ?>">
                            <!-- Nama -->
                            <div class="mb-3">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="password" class="form-control form-control-lg rounded-3"
                                    value="<?= $kasir['password']; ?>" required>
                                <small class="text-muted">
                                    Password akan langsung disimpan jika diubah
                                </small>
                            </div>
