...
<body class="bg-light">
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-1">📏 Tambah Satuan</h3>
                <p class="text-muted mb-0">Tambahkan satuan baru untuk produk</p>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        <form action="../../proses/admin/tambah/proses_tambah_satuan.php" method="POST">
                            <!-- Nama Satuan -->
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Nama Satuan</label>
                                <input type="text" name="nama_satuan" class="form-control form-control-lg rounded-3 "
